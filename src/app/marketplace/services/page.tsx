// File: page.tsx
// Path: /src/app/marketplace/services/page.tsx
// Services listing page - matching Products page layout exactly
    ...
    try {
      ...
      switch (sortBy) {
        case 'newest':
          ...
          break
        case 'price-low':
          // For services, we need to sort by minimum package price
          // This requires a custom approach since packages is JSONB
          query = query.order('created_at', { ascending: false })
          break
        case 'price-high':
          query = query.order('created_at', { ascending: false })
      ...
      if (servicesError) {
        ...
        // Filter by price range (check minimum package price)
      ...
      <main className="flex-1">
        <div className="px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="mb-8">
            ...
            >
              Hire professionals for mixing, mastering, production, and more
            </p>
          </div>
