...
// Layout for protected pages with sidebar
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
      ...
      <div className="flex pt-16">
        ...
        {sidebarOpen && (
          ...
          >
            <aside 
              className="fixed inset-y-0 left-0 w-64 bg-white dark:bg-gray-900 z-50 pt-16"
        ...
        <button
          ...
          className="lg:hidden fixed bottom-6 right-6 z-30 w-14 h-14 bg-primary text-white rounded-full shadow-lg flex items-center justify-center hover:bg-primary-hover transition-colors"
        >
