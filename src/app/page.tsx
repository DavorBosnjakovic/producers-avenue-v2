...
export default function HomePage() {
  ...
  const featuredProducts = [
    ...
    },
    {
      ...
      seller: { name: 'BeatMaker', avatar: '/images/avatars/placeholder.jpg' },
      rating: 5,
      reviewCount: 42,
      isFeatured: true,
    },
    {
      ...
      seller: { name: 'MixMaster', avatar: '/images/avatars/placeholder.jpg' },
      rating: 4.8,
      reviewCount: 18,
      isFeatured: true,
    },
    {
      ...
      seller: { name: 'SynthWave', avatar: '/images/avatars/placeholder.jpg' },
      rating: 4.7,
      reviewCount: 31,
      isFeatured: true,
    },
    {
      ...
      seller: { name: 'RiffMaker', avatar: '/images/avatars/placeholder.jpg' },
      rating: 4.6,
      reviewCount: 15,
      isFeatured: true,
    },
